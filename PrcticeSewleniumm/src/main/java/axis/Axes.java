...
public class Axes {
	...
	public static void main(String[] args) throws InterruptedException 
	{
	  ...
	  //Descendant
	   text = driver.findElement(By.xpath("//a[contains(text(),'Garry.White')]/ancestor::tr/descendant::td[2]")).getText();
	  ...
	  // Following
	   text = driver.findElement(By.xpath("//a[contains(text(),'Garry.White')]/ancestor::tr/following::tr[1]")).getText();
	  ...
	  // Following-siblings
	   text = driver.findElement(By.xpath("//a[contains(text(),'Garry.White')]/ancestor::tr/following-sibling::tr[1]")).getText();
	  ...
	  //Preceding 
	    text = driver.findElement(By.xpath("//a[contains(text(),'Garry.White')]/ancestor::tr/preceding::tr[1]")).getText();
	  ...
	  //Preceding-siblings 
	    text = driver.findElement(By.xpath("//a[contains(text(),'Garry.White')]/ancestor::tr/preceding-sibling::tr[1]")).getText();
